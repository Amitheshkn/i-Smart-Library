...
if ($conn->connect_error) {
 ...
 $res=mysqli_query($conn,"select * from  addbooks where book_name='$bookname'")or die (mysqli_error($conn));;
...
<body>
    <header>
	    <div class="">
		   ...
		   <div class="logo">
		         <a href="home.html">  <img src="SMATY.jpg" align="right"></a>
		     </div>
...
<a href="feedback.html"><button>PROVIDE FEEDBACK</button></a>
